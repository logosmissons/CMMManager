...
namespace CMMManager
{
    public partial class frmCommunicationHelper : Form
    {
        ...
        public frmCommunicationHelper()
        {
            ...
            RNConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
            //RNConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
            connRN = new SqlConnection(RNConnString);

            SalesforceConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=SalesForce; Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
            //SalesforceConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=SalesForce; User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
