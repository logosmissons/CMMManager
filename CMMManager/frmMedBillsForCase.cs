...
namespace CMMManager
{
    public partial class frmMedBillsForCase : Form
    {
        ...
        public frmMedBillsForCase()
        {
            ...
            rn_cnn_str = @"Data Source=cmm-2019data\CMM; Initial Catalog=RN_DB;Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
            //rn_cnn_str = @"Data Source=cmm-2019data\CMM; Initial Catalog=RN_DB;User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
