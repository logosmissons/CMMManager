...
namespace CMMManager
{
    public partial class frmCaseForCommunication : Form
    {
        ...
        public frmCaseForCommunication()
        {
            ...
            SqlRNConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
            //SqlRNConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
