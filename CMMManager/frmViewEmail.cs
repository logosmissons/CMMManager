...
namespace CMMManager
{
    public partial class frmViewEmail : Form
    {
        ...
        private String strPathForEmailAttachments = @"\\10.1.10.60\Sharefolder\EmailAttachments\";

        private EmailContentInfo EmailContent;

        private String connStringRN = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
        //private String connStringRN = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
        private SqlConnection connRN;

        private String connStringSalesforce = @"Data Source=10.1.10.60\CMM; Initial Catalog=SalesForce; Integrated Security=True; MultipleActiveResultSets=True";
        //private String connStringSalesforce = @"Data Source=10.1.10.60\CMM; Initial Catalog=SalesForce; User ID=sa;Password=Yny00516; MultipleActiveResultSets=True";
