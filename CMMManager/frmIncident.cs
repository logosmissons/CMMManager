...
namespace CMMManager
{
    public partial class frmIncident : Form
    {
        ...
        public frmIncident()
        {
            ...
            strRNDBConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;Integrated Security=True; Max Pool Size=200; MultipleActiveResultSets=True";
            //strRNDBConnString = @"Data Source=10.1.10.60\CMM; Initial Catalog=RN_DB;User ID=sa;Password=Yny00516; Max Pool Size=200; MultipleActiveResultSets=True";
